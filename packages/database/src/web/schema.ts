...
export const forms = sqliteTable(
  "forms",
  {
    ...
    sourceSuccessMessage: text("source_success_message"),
...
export const landingPageVersions = sqliteTable(
  "landing_page_versions",
  {
    ...
    publishedDocument: text("published_document"),
    variableSnapshot: text("variable_snapshot"),
...
export const formVersions = sqliteTable(
  "form_versions",
  {
    ...
    variableProjectId: text("variable_project_id"),
    variableSnapshot: text("variable_snapshot"),
    programBinding: text("program_binding"),
    publishedAt: text("published_at"),
...
export const customRedirects = sqliteTable(
  ...
  (table) => [
    ...
    check("custom_redirects_status_check", sql`${table.status} IN ('draft','published')`),
  ],
);
