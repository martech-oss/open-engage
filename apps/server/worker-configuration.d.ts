/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false --env-interface=ServerBindings` (hash: cc0c6c34f2728da9d05d3bf1aca834fe)
// Runtime types generated with workerd@1.20260722.1 2026-07-28 nodejs_compat
interface __BaseEnv_ServerBindings {
	ASSETS_BUCKET: R2Bucket;
	DB: D1Database;
	EMAIL: SendEmail;
	PROGRAM_MEMBER_IMPORT_QUEUE: Queue;
	JOBS_QUEUE: Queue;
	...
	COMPANY_ENRICHMENT_ENABLED: string;
	AGENT_APP: Fetcher /* openengage-agent */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env extends __BaseEnv_ServerBindings {}
}
interface ServerBindings extends __BaseEnv_ServerBindings {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "APP_URL" | "ENVIRONMENT" | "TRANSACTIONAL_FROM_EMAIL" | "TRANSACTIONAL_FROM_NAME" | "REPLY_DOMAIN" | "TURNSTILE_SITE_KEY" | "RAW_EVENT_RETENTION_DAYS" | "COMPANY_ENRICHMENT_ENABLED">> {}
}
