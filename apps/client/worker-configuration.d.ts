/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=../server/wrangler.jsonc --env-interface=CloudflareBindings` (hash: 15a913e2fb3a315a4355ef56f23eed19)
// Runtime types generated with workerd@1.20260722.1 2026-07-28 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	APP_URL: "http://localhost:5173";
	SERVER: Service<typeof import("../server/src/index").default>;
}
